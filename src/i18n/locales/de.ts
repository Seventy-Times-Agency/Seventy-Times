// German (de) UI strings for Seventy Times
...
const strings = {
    ...
    heroMeta2: "Wachstumssystem · Ausgabe 2026",
    ...
    compTitle1: "Wie wir",
    compTitle2: "abschneiden",
    compTitle3: "im Vergleich",
    compLead:
      "Direkter Vergleich: Was sich ändert, wenn Sie statt einer klassischen Agentur oder einem Freelancer Seventy Times an Bord holen.",
    compBadgeUs: "Empfohlen",
    compHeadAgency: "Klassische Agentur",
    compHeadFreelancer: "Einzelner Freelancer",
    compShowAlts: "Vergleich anzeigen",
    compHideAlts: "Vergleich ausblenden",
    compRowSpeedLabel: "Time-to-Launch",
    compRowSpeedUs: "Erste Leads in 30 Tagen",
    compRowSpeedAgency: "60–90 Tage Onboarding",
    compRowSpeedFreelancer: "Hängt von der Verfügbarkeit ab",
    compRowAiLabel: "KI im Workflow",
    compRowAiUs: "Eingebaut: Claude, GPT, eigene Agenten",
    compRowAiAgency: "Selten, meist als Zusatz",
    compRowAiFreelancer: "Fast nie",
    compRowScopeLabel: "Umfang",
    compRowScopeUs: "Ads + Automation + KI als ein System",
    ...
    compRowReportUs: "Live-Dashboard, wöchentlicher Recap",
    compRowReportAgency: "Monatliche PDF-Präsentation",
    compRowReportFreelancer: "Screenshots auf Anfrage",
    compRowContractLabel: "Bindung",
    compRowContractUs: "Monatlich kündbar, jederzeit pausierbar",
    compRowContractAgency: "6–12-Monats-Verträge",
    compRowContractFreelancer: "Pro Projekt, kein SLA",
    compRowRiskLabel: "Wenn jemand krank ist",
    compRowRiskUs: "Pod übernimmt, Arbeit läuft weiter",
    compRowRiskAgency: "Wechsel zur neuen Person, Ramp-up verloren",
    compRowRiskFreelancer: "Projekt steht",
    compDisclaimer:
      "Verallgemeinerung, kein Angriff — es gibt großartige Agenturen und Freelancer. So beschreiben Kunden meistens das, was sie zuvor probiert haben.",
    ...
    prin1Title: "Keine Leistung — ein System",
    prin1Body: "Werbung, KI und Automatisierung als Einzelleistungen sind Standard — das bekommt man überall. Wir bauen daraus eine funktionierende Maschine, in der jeder Kanal den nächsten verstärkt. Daraus entsteht der Multiplikator.",
    prin1Badge: "01",
    prin2Title: "Wir verdienen, wenn Sie verdienen",
    prin2Body: "Unser KPI ist Ihr Umsatz, nicht hübsche Berichte. Je stärker das Geschäft des Kunden wächst, desto stärker wachsen wir. Jeder Start ist eine gemeinsame Wette auf das Ergebnis.",
    prin2Badge: "02",
    prin3Title: "Besessen vom Ergebnis",
    prin3Body: "Wir behandeln Ihr Projekt wie unser eigenes Geschäft: zerlegen die Unit Economics, testen Hypothesen, schreiben um, was nicht trägt. Kein 'reicht schon' — nur das, was die Zahlen wirklich bewegt.",
    prin3Badge: "03",
    prin4Title: "Zahlen offen einsehbar",
    prin4Body: "Jedes Dashboard, jedes Creative, jedes Gebot und jeder Test liegt 24/7 in Ihren Händen. Sie sehen jede Entscheidung und ihre Wirkung. Vertrauen entsteht durch Zahlen, nicht durch schöne Worte.",
    prin4Badge: "04",
    ...
    leadBudget: "Monatsbudget (Richtwert)",
    leadBudgetNotSure: "Noch unklar",
    leadBudgetUnder1k: "Bis $1.000 / Monat",
    leadBudget1k3k: "$1.000–3.000 / Monat",
    leadBudget3k10k: "$3.000–10.000 / Monat",
    leadBudget10kPlus: "$10.000+ / Monat",
