// English (en) UI strings for Seventy Times
...
const strings = {
    ...
    svcTitle3: "do",
    svcLead:
      "Four pillars that work as a single growth engine. Click a card to expand the details.",
    ...
    compTitle3: "up",
    compLead:
      "A side-by-side look at what changes when you bring in Seventy Times instead of a classic agency or a single freelancer.",
    ...
    compRowScopeUs: "Ads + automation + AI as one system",
    ...
    compRowReportUs: "Live dashboard, weekly summary",
    compRowReportAgency: "PDF deck once a month",
    compRowReportFreelancer: "Ad-hoc screenshots",
    compRowContractLabel: "Commitment",
    compRowContractUs: "Month-to-month, pause anytime",
    compRowContractAgency: "6–12 month contracts",
    compRowContractFreelancer: "Per-project, no SLA",
    compRowRiskLabel: "If a person is sick",
    compRowRiskUs: "Pod covers, work continues",
    compRowRiskAgency: "Reassigned, ramp-up loss",
    compRowRiskFreelancer: "Project pauses",
    compDisclaimer:
      "Generalisation, not a swipe — there are great agencies and great freelancers. This is the picture we see most often when clients describe what they tried before.",
    ...
    prin1Title: "Not a service — a system",
    prin1Body: "Ads, AI and automation as separate services are commodities — you can buy them anywhere. We assemble them into a working machine where each channel amplifies the next. That's where the multiplier comes from.",
    prin1Badge: "01",
    prin2Title: "We earn when you earn",
    prin2Body: "Our KPI is your revenue, not vanity reports. The bigger the client's business grows, the bigger we grow. Every launch is a shared bet on the outcome.",
    prin2Badge: "02",
    prin3Title: "Obsessed with the result",
    prin3Body: "We treat your project like our own business: dig into the unit economics, test hypotheses, rewrite whatever isn't pulling weight. No 'good enough' — only what actually moves the numbers.",
    prin3Badge: "03",
    prin4Title: "Numbers in the open",
    prin4Body: "Every dashboard, creative, bid and test sits in your hands 24/7. You see every decision and its effect. Trust is built on numbers, not on pretty words.",
    prin4Badge: "04",
    ...
    leadFillStep3: "Please describe what you need",
    leadNext: "Continue",
    leadBack: "Back",
    leadModeAll: "Show all fields at once",
    leadModeSteps: "Step-by-step instead",
