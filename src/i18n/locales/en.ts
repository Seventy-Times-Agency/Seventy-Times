...
const strings = {
    ...
    prin1Title: "Start small, expand later",
    prin1Body: "We launch one direction, show a result in 2–3 weeks and only then scale. No long contracts — you can pause at any time.",
    prin1Badge: "01",
    prin2Title: "Numbers every Monday",
    prin2Body: "Weekly report with clear KPIs: what worked, what didn't, what we change next week. No fog, no generic copy, no closed dashboards.",
    prin2Badge: "02",
    prin3Title: "Honest about results",
    prin3Body: "We don't sell '100× in a week' — those numbers don't exist in marketing. We work on measurable progress, so on every iteration you can see which way the project economy is moving.",
    prin3Badge: "03",
    prin4Title: "Stop-point by default",
    prin4Body: "If the approach isn't producing a result in 6–8 weeks, we'll be the first to say so. The budget stays with you, the reputation stays with us. Trust matters more than one invoice.",
    prin4Badge: "04",
