...
const strings = {
    ...
    svc4Note: "Тексты и брендинг — на стороне клиента. Хостинг и домен — на вашем аккаунте.",
    svc4Inc: [
    ...
    faq5a:
      "Минимальный срок прописан в договоре (3–6 месяцев в зависимости от пакета). После — продление по месяцам, прерывается с уведомлением за 30 дней. Если за 90 дней мы не запустили систему — возвращаем 50 % setup-fee.",
    ...
    faq7a:
      "Тексты адаптируем под структуру сайта, но не пишем оригинальный копирайтинг с нуля. Логотипы и брендинг тоже не делаем — используем ваши готовые материалы. Если нужно — посоветуем подрядчика.",
    ...
    faq10a:
      "Банковский перевод, Stripe, PayPal Business. Setup — 100 % предоплата, ведение — ежемесячно вперёд.",
    faq11q: "С какими валютами работаете?",
    faq11a:
      "Основная — USD. Принимаем EUR по курсу ECB. RUB / UAH — по запросу.",
