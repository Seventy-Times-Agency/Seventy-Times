...
const strings = {
    ...
    simCta: "Обсудить мой стек с Тесс",
    ...
    privacyBody: [
      ...
      },
      {
        ...
        text: 'Через форму заявки: ваше имя, контакт (email или Telegram), название бизнеса, описание задачи. Через форму отзыва: имя, должность, локация, текст отзыва и персональный код клиента. Через чат с Тесс: текст сообщений, отправленных нам. Мы не собираем платежную информацию и не используем cookies для трекинга.',
      },
      {
      ...
      },
      {
        ...
        text: 'Заявки и отзывы пересылаются в наш внутренний Telegram-чат. Логи сайта хранятся у нашего хостинг-провайдера (Vercel) в техническом виде и не содержат персональных данных. Чат с Тесс обрабатывается через API Anthropic для генерации ответов.',
      },
      {
    ...
    termsBody: [
      ...
      },
      {
        ...
        text: 'Мы честно описываем наши услуги, цены обсуждаем индивидуально, результаты — конкретные KPI, которые оговариваем до старта. Чат с Тесс — вспомогательный инструмент, а не юридическое предложение.',
      },
      {
