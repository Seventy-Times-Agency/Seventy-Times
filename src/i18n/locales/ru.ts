...
const strings = {
    ...
    faq14q: "В какой валюте можно платить?",
    faq14a:
      "Цены указаны в долларах США, но платить можно в локальной валюте — банковский перевод, Wise, крипта, локальные варианты по стране. Конкретный способ согласуем на старте: выбираем тот, что удобнее на вашей стороне.",
