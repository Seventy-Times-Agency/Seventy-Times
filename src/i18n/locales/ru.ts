...
const strings = {
    ...
    venTitle3: "Ванесса.",
    venLead:
      "Ванесса — AI-ассистент на базе Claude, обученный под ваш бизнес. Она общается с клиентами на сайте, в Telegram и Instagram, квалифицирует лиды и передаёт горячих вам напрямую. Такого же бота мы создаём под каждый проект.",
    venBullets: [
    ...
    simCta: "Обсудить мой стек с Ванесса",
    ...
    privacyBody: [
      ...
      },
      {
        ...
        text: 'Заявки и отзывы пересылаются в наш внутренний Telegram-чат. Логи сайта хранятся у нашего хостинг-провайдера (Vercel) в техническом виде и не содержат персональных данных. Чат с Ванесса обрабатывается через API Anthropic для генерации ответов.',
      },
      {
