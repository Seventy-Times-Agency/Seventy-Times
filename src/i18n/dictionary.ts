...
const dict = {
  ru: {
    ...
    // Growth Simulator (cards-based, simpler)
    simEyebrow: "— 70× Симулятор роста",
    simTitle1: "Соберите",
    simTitle2: "свой",
    simTitle3: "стек.",
    simLead:
      "Включайте направления — смотрите как они компонуются в общий рост. Это не гарантия, а наглядная модель связки Реклама + Автоматизация + AI.",
    simAdsTag: "01 / Реклама",
    simAdsName: "Реклама",
    simAdsDesc: "Платный таргет в Meta, Google и TikTok — главный приток новых лидов.",
    simAdsMetric: "к лидам",
    simAutoTag: "02 / Автоматизация",
    simAutoName: "Автоматизация",
    simAutoDesc: "Воронки, интеграции, авто-отчёты — освобождают время команды.",
    simAutoMetric: "к скорости",
    simAiTag: "03 / AI",
    simAiName: "AI-консультант",
    simAiDesc: "Венеса работает с лидами 24/7 — растит конверсию из лида в клиента.",
    simAiMetric: "к конверсии",
    simIntensity: "Интенсивность",
  ...
  en: {
    ...
    simTitle3: "stack.",
    simLead:
      "Toggle each pillar's intensity — see how they compound into overall growth. Not a guarantee — a visual model of how Ads + Automation + AI work together.",
    simAdsTag: "01 / Ads",
    simAdsName: "Ads",
    simAdsDesc: "Paid targeting on Meta, Google and TikTok — your main source of new leads.",
    simAdsMetric: "to leads",
    simAutoTag: "02 / Automation",
    simAutoName: "Automation",
    simAutoDesc: "Funnels, integrations, auto-reports — free up your team's time.",
    simAutoMetric: "to speed",
    simAiTag: "03 / AI",
    simAiName: "AI consultant",
    simAiDesc: "Venesa works leads 24/7 — lifts conversion from lead to customer.",
    simAiMetric: "to conversion",
    simIntensity: "Intensity",
  ...
  de: {
    ...
    simTitle3: "Stack.",
    simLead:
      "Stellen Sie die Intensität jeder Säule ein — sehen Sie, wie sie zum Gesamtwachstum kombinieren. Keine Garantie — ein visuelles Modell, wie Werbung + Automatisierung + KI zusammenwirken.",
    simAdsTag: "01 / Werbung",
    simAdsName: "Werbung",
    simAdsDesc: "Bezahltes Targeting auf Meta, Google und TikTok — Ihre Hauptquelle für neue Leads.",
    simAdsMetric: "zu Leads",
    simAutoTag: "02 / Automatisierung",
    simAutoName: "Automatisierung",
    simAutoDesc: "Funnels, Integrationen, Auto-Berichte — entlasten Ihr Team.",
    simAutoMetric: "zu Tempo",
    simAiTag: "03 / KI",
    simAiName: "KI-Beraterin",
    simAiDesc: "Venesa bearbeitet Leads 24/7 — steigert die Conversion von Lead zu Kunde.",
    simAiMetric: "zu Conversion",
    simIntensity: "Intensität",
