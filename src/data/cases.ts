  ...
  // ── Convioo · our own AI lead-gen product ─────────────────
  {
    ...
    study: {
      ...
      summary: {
        ...
        ua: "Наш власний продукт — B2B-платформа лідогенерації з легкою CRM для маркетингових агенцій. Вебзастосунок на Next.js поверх Python-бекенду: пошук через Google Places, глибокий enrichment, AI-скоринг і чернетки outreach від Claude, та Henry — вбудований AI-асистент.",
      },
      metrics: [
        {
          ...
          ua: "AI-скоринг + чернетки outreach (Claude)",
        },
        {
      ...
      meta: {
        ...
        ua: "Наш продукт · Next.js + Python · Google Places · Claude",
      },
      niche: {
        en: "SaaS · AI · B2B lead-gen",
        ru: "SaaS · ИИ · B2B-лидоген",
        de: "SaaS · KI · B2B-Leadgen",
        ua: "SaaS · ШІ · B2B-лідоген",
      },
      stats: [
        {
          value: "≤50",
      ...
      features: [
        {
          ...
          text: {
            ...
            ua: "Пошук B2B-лідів — ніша + регіон, видача з Google Places",
          },
        },
        {
          icon: "🧠",
          text: {
            ...
            ua: "Глибокий enrichment до 50 лідів — сайт, соцмережі, відгуки, decision-maker",
          },
        },
        {
          icon: "⭐",
          text: {
            ...
            ua: "AI-скоринг і чернетки outreach через Claude Haiku",
          },
        },
        {
          icon: "🤖",
          text: {
            ...
            ua: "Henry — вбудований AI-асистент: чат, щотижневий check-in, ресерч за лідом",
          },
        },
        {
          icon: "🗂️",
          text: {
            ...
            ua: "Повноцінна CRM — статуси, нотатки, кастом-поля, задачі, активіті-таймлайн",
          },
        },
        {
          icon: "📤",
          text: {
            ...
            ua: "Excel + CSV експорт сесії або всієї CRM",
          },
        },
      ],
      chat: {
        ...
        messages: [
          {
            ...
            text: {
              ...
              ua: "Привіт, я Henry. Назви нішу й регіон — зберу першу партію лідів.",
            },
          },
          {
            role: "user",
            text: {
              ...
              ua: "Стоматології в Остіні, Техас.",
            },
          },
          {
            role: "bot",
            text: {
              ...
              ua: "Уже шукаю через Google Places, потім збагачу й оціню топ-50 за релевантністю. Зробити чернетки outreach для найгарячіших?",
            },
          },
        ],
      },
          ...
          items: [
            {
              ...
              ua: "Команди із запрошеннями та верифікацією по email (Resend)",
            },
            {
              en: "GDPR data export",
              ru: "GDPR-экспорт данных",
              de: "DSGVO-Datenexport",
              ua: "GDPR-експорт даних",
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              ua: "Фонові пошуки через Redis + воркер arq",
            },
            {
              ...
              ua: "Startup-recovery — завислий пошук авто-позначається як failed",
            },
            {
              ...
              ua: "CI на кожен push — postgres, міграції, лінт ruff, pytest",
            },
          ],
        },
      ],
      insight: {
        ...
        ua: "Convioo — наш власний продукт: ми його робимо, тримаємо в проді й самі використовуємо для пошуку лідів. Зараз в активній розробці.",
      },
      stack: [
        "Next.js",
        "Python / FastAPI",
